...
const items: Array<{
  ...
  { label: "Create Invoice", page: "create-invoice", icon: FilePlus2 },
  { label: "Sales", page: "sales", icon: BarChart3 },
  { label: "Add Sale", page: "add-sale", icon: ShoppingBag },
  { label: "Customers", page: "customers", icon: Users },
  { label: "Orders / Jobs", page: "orders", icon: ClipboardList },
